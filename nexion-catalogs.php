...
<body>
    ...
    <section class="w-full bg-center bg-cover relative pt-20 pb-20 sm:pt-24 sm:pb-24 px-4 sm:px-6 lg:px-12 2xl:px-16"
        ...
        <div class="relative z-10 text-center text-white max-w-4xl mx-auto">
            ...
            <nav class="text-sm sm:text-base space-x-2">
                ...
                <span>Catalogs - Nexion Project Range</span>
            </nav>
        </div>
    </section>
    ...
    <?php
    $pdfCatalogs = [
        ['file' => './uploads/catalogs/Nexion-Lithic-Collection.pdf'],
        ['file' => './uploads/catalogs/Nexion-Marble-Gallery.pdf'],
        ['file' => './uploads/catalogs/Nexion-Master-Catalogue.pdf'],
        ['file' => './uploads/catalogs/Nexion-Ombre-Collection.pdf'],
        ['file' => './uploads/catalogs/Nexion-Riga-Collection.pdf'],
