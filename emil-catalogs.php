...
<body>
    ...
    <section class="w-full bg-center bg-cover relative pt-20 pb-20 sm:pt-24 sm:pb-24 px-4 sm:px-6 lg:px-12 2xl:px-16"
        style="background-image: url('./assets/img/EMIL CERAMICA IMAGE.jpg');">
        ...
        <div class="relative z-10 text-center text-white max-w-4xl mx-auto">
            ...
            <nav class="text-sm sm:text-base space-x-2">
                ...
                <span>Catalogs - Emil Project Range</span>
            </nav>
        </div>
    </section>
    ...
    <?php
    $pdfCatalogs = [
        ['file' => './uploads/catalogs/Elegance Pro Catalogo 2024.12 Web.pdf'],
        ['file' => './uploads/catalogs/emilceramica_cg_202509_web.pdf'],
        ['file' => './uploads/catalogs/Re-Play Concrete Catalogo 2024.10 Web.pdf'],
        ['file' => './uploads/catalogs/StoneProject Catalogo 2024.10 Web.pdf'],
        ['file' => './uploads/catalogs/TdM PureOnyx Catalogo 2024.12 Web.pdf'],
        ['file' => './uploads/catalogs/TdM Reloaded Catalogo 2025.09 Web.pdf'],
        ['file' => './uploads/catalogs/TdM Selection Catalogo 2025.05 Web.pdf'],
        ['file' => './uploads/catalogs/Unique Travertine Catalogo 2025.04 Web.pdf'],
        ['file' => './uploads/catalogs/UniqueMarble Catalogo 2025.08 Web.pdf']
