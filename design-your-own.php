...
<head>
    ...
    <title>Exel Holdings - Design Your Own</title>
...
<body>
    ...
    <section class="w-full bg-cover bg-center relative pt-24 pb-24 px-4 sm:px-6 lg:px-12"
        ...
        <div class="relative z-10 text-center text-white max-w-4xl mx-auto px-2 sm:px-4">
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">Design Your Own</h1>
        ...
        <div class="flex flex-col lg:flex-row bg-white overflow-hidden border border-gray-100">
            ...
            <div class="w-full lg:w-1/4 border-b lg:border-b-0 lg:border-r border-gray-200 bg-gradient-to-b from-gray-50 to-white">
                <div class="flex lg:flex-col justify-around lg:justify-start p-2">
                    <button style="background-color: #e9e9e9;" onclick="showTab('Plain')" id="Plain-tab"
                    ...
                    <button style="background-color: #e9e9e9;" onclick="showTab('MURALS')" id="MURALS-tab"
                    ...
                    <button style="background-color: #e9e9e9;" onclick="showTab('MODULAR')" id="MODULAR-tab"
                        class="tab-btn w-full px-6 py-4 text-left font-semibold text-gray-700 hover:text-red-600 hover:bg-red-50 focus:outline-none transition-all duration-300 rounded-lg my-1">
                        MODULAR DESIGNS
                    </button>
                    <button style="background-color: #e9e9e9;" onclick="showTab('DÉCORATIONS')" id="DÉCORATIONS-tab"
                        class="tab-btn w-full px-6 py-4 text-left font-semibold text-gray-700 hover:text-red-600 hover:bg-red-50 focus:outline-none transition-all duration-300 rounded-lg my-1">
                        DÉCORATIONS
                    </button>
                </div>
            ...
            <div class="w-full lg:w-3/4 p-8 bg-gradient-to-br from-white to-gray-50">
                ...
                <!-- Tiles List -->
                <div id="Plain-content" class="tab-content fade-in">
                    <div class="space-y-6">
                ...
                <!-- MURALS List -->
                <div id="MURALS-content" class="tab-content hidden">
                    <div class="space-y-6">
                        <div class="flex items-center justify-between bg-white rounded-2xl shadow-lg border border-gray-100 p-4">
                            <div class="flex items-center gap-4">
                                <img src="./assets/img/pdf.png" alt="PDF Icon"
                ...
                <!-- MODULAR DESIGNS List -->
                <div id="MODULAR-content" class="tab-content hidden">
                    <div class="space-y-6">
                        <div class="flex items-center justify-between bg-white rounded-2xl shadow-lg border border-gray-100 p-4">
                            <div class="flex items-center gap-4">
                                <img src="./assets/img/pdf.png" alt="PDF Icon"
                        ...
                        <div class="flex items-center justify-between bg-white rounded-2xl shadow-lg border border-gray-100 p-4">
                            <div class="flex items-center gap-4">
                                <img src="./assets/img/pdf.png" alt="PDF Icon"
                                    class="w-16 h-16 object-contain bg-gray-50 rounded-lg">
                                <h3 class="text-lg font-semibold text-gray-800">MURALS - Ledges</h3>
                            </div>
                            <div class="flex gap-3">
                ...
                <!-- DÉCORATIONS List -->
                <div id="DÉCORATIONS-content" class="tab-content hidden">
                    <div class="space-y-6">
                        <div class="flex items-center justify-between bg-white rounded-2xl shadow-lg border border-gray-100 p-4">
                            <div class="flex items-center gap-4">
                                <img src="./assets/img/pdf.png" alt="PDF Icon"
                                    class="w-16 h-16 object-contain bg-gray-50 rounded-lg">
                                <h3 class="text-lg font-semibold text-gray-800">DÉCORATIONS Guide</h3>
                            </div>
                            <div class="flex gap-3">
