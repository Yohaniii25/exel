...
$categoryName = 'Washroom Accessories';
...
if ($categoryFilter == 0) {
    $showCategories = getCategoryChildren($conn, 5); 
} elseif ($currentCategory) {
    if (getCategoryChildrenCount($conn, $categoryFilter) > 0) {
        $showCategories = getCategoryChildren($conn, $categoryFilter); 
    } else {
        $showProducts = true; 
    }
}
...
$breadcrumbs = [['name' => 'Home', 'url' => 'index.php'], ['name' => 'Washroom Accessories', 'url' => '?category=0']];
if ($currentCategory) {
    $path = [];
...
<head>
    ...
    <title>Exel Holdings - Washroom Accessories</title>
