...
if ($categoryFilter == 0) {
    $showCategories = getCategoryChildren($conn, 2); 
...
$breadcrumbs = [['name' => 'Home', 'url' => 'index.php'], ['name' => 'Faucets & Showers', 'url' => '?category=0']];
if ($currentCategory) {
    $path = [];
...
<head>
    ...
    <title>Exel Holdings - Faucets & Showers</title>
