...
$subQry = "SELECT * FROM categories WHERE parent_id = 17 ORDER BY name ASC";
...
<div id="sidebar"
    ...
    <div class="p-6 sidebar-content">
        <div class="sidebar-header p-4 -m-4 mb-4">
            <h3 class="text-xl font-bold text-gray-800 mb-3 sidebar-item">Adhesive & Grout & Industrial Flooring</h3>
