...
$ranges = [
    [
        'id' => 1,
        'name' => 'Designer Range',
        'link' => 'designer-range.php',
        'image' => './uploads/categories/Sukabumi.jpg'
        
    ],
    [
        'id' => 2,
        'name' => 'Design Your Own',
        'link' => 'design-your-own.php',
        'image' => './uploads/categories/24102.jpg'
    ]
];
...
<head>
    ...
    <title>Exel Holdings - Mosaics</title>
...
<section class="w-full bg-center relative pt-20 pb-20 sm:pt-24 sm:pb-24 px-4 sm:px-6 lg:px-12 2xl:px-16 header-section"
    ...
    <div class="relative z-10 text-center text-white max-w-3xl sm:max-w-4xl 2xl:max-w-5xl mx-auto">
        <h1 class="text-2xl sm:text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl font-bold mb-4">Mosaics</h1>
        <nav class="text-xs sm:text-sm md:text-base 2xl:text-lg space-x-2">
            ...
            <span class="text-white">Mosaics</span>
        </nav>
    </div>
</section>
