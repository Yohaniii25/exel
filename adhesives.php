...
if ($categoryFilter != 0) {
    $descSql = "SELECT name, image, description 
                FROM categories 
...
<head>
    ...
    <title>Exel Holdings - Adhesive & Grout & Industrial Flooring</title>
        ...
        <div class="relative z-10 text-center text-white max-w-3xl sm:max-w-4xl 2xl:max-w-5xl mx-auto px-2 sm:px-4">
            <h1 class="text-2xl sm:text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl font-bold mb-3 sm:mb-4 leading-tight">
                ...
                if (!empty($categoryName)) {
                    ...
                    echo 'Adhesive & Grout & Industrial Flooring';
                }
                ?>
            </h1>
            <nav class="text-xs sm:text-sm md:text-base 2xl:text-lg space-x-1 sm:space-x-2">
                ...
                if (!empty($categoryName)) {
                    ...
                    echo '<span class="text-white">/ Adhesive & Grout & Industrial Flooring</span>';
                }
                ?>
            </nav>
        </div>
            ...
            <div class="mb-8 sm:mb-12 2xl:mb-16 text-left mx-auto align-items-justify">
                <h2 class="text-2xl sm:text-3xl 2xl:text-4xl font-bold text-gray-900 mb-4">
                    ...
                    if (!empty($categoryName)) {
                        ...
                        echo 'Explore Adhesive & Grout & Industrial Flooring';
                    }
                    ?>
                </h2>
                    ...
                    <?php else: ?>
                        <div class="col-span-full text-center py-16">
                            <div class="max-w-md mx-auto">
                                ...
                                <h3 class="text-xl 2xl:text-2xl font-bold text-gray-900 mb-2">No Subcategories Found</h3>
                                <p class="text-gray-500 mb-6 text-base 2xl:text-lg">No subcategories are available for Natural
                                    Stones.</p>
                            </div>
                        </div>
                    <?php endif; ?>
