...
<body>
    ...
    <section class="w-full bg-cover bg-center relative pt-24 pb-24 px-4 sm:px-6 lg:px-12 mt-[130px]" style="background-image: url('./assets/img/breadcrumb-bg1.jpg');">
        ...
        <div class="relative z-10 text-center text-white max-w-4xl mx-auto px-2 sm:px-4">
            ...
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">Taps & Faucets</h1>
            ...
            <nav class="text-xs sm:text-sm md:text-base space-x-1 sm:space-x-2">
                ...
                <span class="text-white">Taps & Faucets</span>
            </nav>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden shadow hover:shadow-lg transition">
                    <img src="./assets/img/products/16.jpg" alt="Product 1" class="w-full h-60 object-cover">
                    <div class="p-4 text-center">
                        <h3 class="text-lg font-semibold text-gray-800">Basin Area</h3>
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden shadow hover:shadow-lg transition">
                    <img src="./assets/img/products/17.jpg" alt="Product 2" class="w-full h-60 object-cover">
                    <div class="p-4 text-center">
                        <h3 class="text-lg font-semibold text-gray-800">Blush Sensor</h3>
                        <p class="text-blue-600 text-sm mt-1">Rs. 12,500.00</p>
                    </div>
                </div>

                <div class="bg-gray-50 rounded-lg overflow-hidden shadow hover:shadow-lg transition">
                    <img src="./assets/img/products/18.jpg" alt="Product 2" class="w-full h-60 object-cover">
                    <div class="p-4 text-center">
                        <h3 class="text-lg font-semibold text-gray-800">Arc</h3>
                        <p class="text-blue-600 text-sm mt-1">Rs. 12,500.00</p>
                    </div>
                </div>
